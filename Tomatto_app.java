package project_Tomatto;

import java.util.Scanner;

public class Tomatto_app {
	...
	public static void main(String[] args) throws Exception {
		...
		case 2: {
			System.out
					.println("\tThanks For Selecting       ************* Eats_The_Arbs Resturant************         \t"
							+ (char) 1 + "\n");
			Thread.sleep(1000);
		...
		case 3: {
			System.out.println("\t THANKS FOR SELECTING     ************ S S HYDERBAD BRIYANI **********         \t"
					+ (char) 1 + "\n");
			Thread.sleep(1000);
		...
		case 4: {
			System.out
					.println("\t THANKS FOR SELECTING     ************ BUHARI **********         \t" + (char) 1 + "\n");
			Thread.sleep(1000);
			System.out.println("1.Special Briyani\n2.Dum Briyani\n3.Chicken Briyani\n4.Exit");
			int food = s.nextInt();
			switch (food) {
